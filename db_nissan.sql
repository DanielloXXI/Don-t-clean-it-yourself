...
--
-- Хост: MySQL-8.0
-- Время создания: Янв 26 2025 г., 00:49
...
INSERT INTO `applications` (`id_application`, `id_user`, `address`, `tel`, `status`, `date`, `serviceType`, `payment`, `reason`) VALUES
(3, 6, 'г. Москва  ааааааааа', '+72222222222', 'выполнена', '2025-01-31 15:47:00', 'Общий клининг', 'наличные', NULL),
(4, 7, 'ул. Карла Маркса, 51, стр. 1', '+79292399393', 'отменена', '2025-02-13 20:52:00', 'Послестроительная уборка', 'наличные', 'не отвечает на телефон'),
(6, 8, 'Московский проспект, 57, Архангельск', '+72832382838', 'в работе', '2025-01-28 02:55:00', 'Генеральная уборка', 'банковская карта', NULL),
(7, 7, 'улица Касаткиной, 9с3, Архангельск', '+79992523332', 'в работе', '2025-02-05 08:35:00', 'Генеральная уборка', 'банковская карта', NULL),
(8, 7, 'Воскресенская улица, 20, кв.3, Архангельск', '+78238283288', 'в работе', '2025-01-29 00:31:00', 'Иная услуга', 'наличные', NULL);
...
--
ALTER TABLE `applications`
  MODIFY `id_application` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
